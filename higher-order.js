...
*/
const newArr=mixedNumbers.filter(element => 
  element %2===0);
...
//Code Here
let postTaxPrices= prices.map(el => el=el*1.07);
...
//Code Here
let myStrongest=monstersInYourPocket.filter((el,index, )=> el.index.CP>200);
...
let orderTotals=orders.reduce((acc,el,index)=> acc+ el.price);
